...
RSpec.describe Hospodar do
  ...
  describe 'inheritance' do
    ...
    it 'overrides components' do
      ...
      expect(child_operation_class.included_modules).to include(Hospodar.registered_modules.last)
    end
  end
  ...
  describe 'double inheritance' do
    ...
    it 'overrides components' do
      ...
      expect(operation.call).to eq(value.merge(child: true))
      expect(child_of_child_operation_class.included_modules).to include(Hospodar.registered_modules.last)
    end
  end
